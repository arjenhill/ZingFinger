function minit() {
  ...
  var _ = {
    getLength: function getLength(v1) {
      if (
        (typeof v1 === "undefined" ? "undefined" : _typeof(v1)) !== "object"
      ) {
    ...
    getAngle: function getAngle(v1, v2) {
      if (
        (typeof v1 === "undefined" ? "undefined" : _typeof(v1)) !== "object" ||
        (typeof v2 === "undefined" ? "undefined" : _typeof(v2)) !== "object"
      ) {
    ...
    getVector: function getVector(p1, p2) {
      if (
        (typeof p1 === "undefined" ? "undefined" : _typeof(p1)) !== "object" ||
        (typeof p2 === "undefined" ? "undefined" : _typeof(p2)) !== "object"
      ) {
